        ...
        <div class="row">
            <div class="col-12 pad-0">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="#">মেনু নির্বাচন করুন</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle color-green" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ই-সেবাসমূহ</a>
                                <div class="dropdown-menu color-green" aria-labelledby="navbarDropdownMenuLink">
                                    <ul>
                                        <li class="show-submenu-1">
                                            <a class="dropdown-item">মোবাইল অ্যাপ</a>
                                            <ul class="navbar-nav submenu">
                                        ...
                                        <li class="show-submenu-2">
                                            <a class="dropdown-item">জাতীয় ই-সেবা</a>
                                            <ul class="navbar-nav submenu">
                                        ...
                                        <li class="show-submenu-3">
                                            <a class="dropdown-item">জেলা ই-সেবা কেন্দ্র</a>
                                            <ul class="navbar-nav submenu">
                                        ...
                                        <li class="show-submenu-4">
                                            <a class="dropdown-item">ইউনিয়ন ডিজিটাল সেন্টার</a>
                                            <ul class="navbar-nav submenu">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle color-red" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">সরকারি অফিস</a>
                                <div class="dropdown-menu color-red" aria-labelledby="navbarDropdownMenuLink">
                                    <ul>
                                        <li class="show-submenu-1">
                                            <a class="dropdown-item">আইন-শৃঙ্খলা ও নিরাপত্তা বিষয়ক</a>
                                            <ul class="navbar-nav submenu">
                                                ...
                                                <li><a class="dropdown-item" href="http://dncdhakametro.dhaka.gov.bd/">মাদকদ্রব্য নিয়ন্ত্রণ অধিদপ্তর,ঢাকা মেট্রো উপ - অঞ্চল</a></li>
                                                <li><a class="dropdown-item" href="http://rab.dhaka.gov.bd/">র&zwnj;্যাব</a></li>
                                            </ul>
                                        </li>
                                        <li class="show-submenu-2">
                                            <a class="dropdown-item">শিক্ষা ও সংস্কৃতি</a>
                                            <ul class="navbar-nav submenu">
                                        ...
                                        <li class="show-submenu-3">
                                            <a class="dropdown-item">কৃষি ও খাদ্য বিষয়ক</a>
                                            <ul class="navbar-nav submenu">
                                                <li><a class="dropdown-item" href="http://cdb.dhaka.gov.bd/">তুলা উন্নয়ন বোর্ড, ঢাকা জোন</a></li>
                                                <li><a class="dropdown-item" href="http://badc.dhaka.gov.bd/">নির্বাহী প্রকৌশলীর (সওকা) কার্যালয়, বিএডিসি, ঢাকা রিজিয়ন</a></li>
                                                <li><a class="dropdown-item" href="http://smbadc.dhaka.gov.bd/">উপ পরিচালক (বীজ বিপণন), বিএডিসি, ঢাকা অঞ্চল,ঢাকা-এর কার্যালয়</a></li>
                                        ...
                                        <li class="show-submenu-4">
                                            <a class="dropdown-item">স্বাস্থ্য বিষয়ক</a>
                                            <ul class="navbar-nav submenu">
                                                <li><a class="dropdown-item" href="http://fpo.dhaka.gov.bd/">জেলা পরিবার পরিকল্পনা কার্যালয়, আজিমপুর, ঢাকা।</a></li>
                                                <li><a class="dropdown-item" href="http://cs.dhaka.gov.bd/">সিভিল সার্জনের কার্যালয়</a></li>
                                            </ul>
                                        </li>
                                        <li class="show-submenu-5">
                                            <a class="dropdown-item">প্রকৌশল ও যোগাযোগ</a>
                                            <ul class="navbar-nav submenu">
                                        ...
                                        <li class="show-submenu-6">
                                            <a class="dropdown-item">মানব সম্পদ উন্নয়ন বিষয়ক</a>
                                            <ul class="navbar-nav submenu">
                                                <li><a class="dropdown-item" href="http://dwa.dhaka.gov.bd/">জেলা মহিলা বিষয়ক কর্মকর্তার কার্যালয়, ঢাকা</a></li>
                                        ...
                                        <li class="show-submenu-7">
                                            <a class="dropdown-item">অন্যান্য অফিসসমূহ</a>
                                            <ul class="navbar-nav submenu">
            ...
            <div class="col-12 pad-0">
                <nav id="primary_nav_wrap">
                    ...
                    <ul>
                        <li class="nav-item active"><a class="nav-link color-black" href="main.php"><i class="fa fa-home" aria-hidden="true"></i></a></li>
                        <li class="nav-item"><a class="nav-link color-green" href="dhaka-south-city.php">ঢাকা মহানগর দক্ষিণ</a></li>
                        <li class="nav-item"><a class="nav-link dropdown-toggle color-orange" href="thana.php" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">থানা</a>
                            <ul class="color-orange">
                                <li><a class="dropdown-item" href="word.php">ওয়ার্ড</a></li>
                                <li><a class="dropdown-item" href="union.php">ইউনিয়ন</a></li>
                                <li><a class="dropdown-item" href="#">Sub Menu 4</a>
                                    <ul>
                                        <li><a class="dropdown-item" href="#">Deep Menu 1</a>
                                            <ul>
                                                <li><a class="dropdown-item" href="#">Sub Deep 1</a></li>
                                                <li><a class="dropdown-item" href="#">Sub Deep 2</a></li>
                                                <li><a class="dropdown-item" href="#">Sub Deep 3</a></li>
                                                <li><a class="dropdown-item" href="#">Sub Deep 4</a></li>
                                            </ul>
                                        </li>
                                        <li><a class="dropdown-item"href="#">Deep Menu 2</a></li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="#">Sub Menu 5</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link color-magenta" href="thotto-batayan.php">তথ্য বাতায়ন</a></li>
                        <li class="nav-item"><a class="nav-link color-cyan" href="press-realise.php">প্রেস রিলিজ</a></li>
