                    ...
                    <ul>
                        ...
                        <li class="nav-item mega-menu-li"><a class="nav-link dropdown-toggle color-green" href="{{url('/dhaka-south-city')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ঢাকা মহানগর দক্ষিণ</a>
                            <ul class="color-green mega-menu">
                                <li><a class="dropdown-item color-green" href="{{url('/word')}}">কার্যনির্বাহী সংসদ</a></li>
                                <li><a class="dropdown-item color-green" href="{{url('/union')}}">কার্যনির্বাহী সংসদ সদস্য</a></li>
                                <li><a class="dropdown-item color-green" href="{{url('/union')}}">উপদেষ্টা পরিষদ সদস্য</a></li>
                                <li><a class="dropdown-item color-green dropdown-toggle" href="{{url('/union')}}">সভাপতি/সাধারণ সম্পাদক</a>
